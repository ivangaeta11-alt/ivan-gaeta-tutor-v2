    ...
    <div className="min-w-0 max-w-full">
      ...
      <div className="grid sm:grid-cols-2 gap-6 min-w-0">
        <DashboardCard title="Dati personali">
          <dl className="space-y-3 min-w-0">
            <div>
              ...
              <dd className="text-slate-800 font-medium mt-0.5 break-words">{promoter.displayName}</dd>
            </div>
            <div>
              <dt className="text-xs font-bold uppercase tracking-wider text-slate-400">Email</dt>
              <dd className="text-slate-800 font-medium mt-0.5 break-all">{promoter.email}</dd>
            </div>
          </dl>
        ...
        <DashboardCard title="Dati account">
          <dl className="space-y-3 min-w-0">
            <div>
              ...
              <dd className="font-mono text-slate-800 font-medium mt-0.5 break-all">
            ...
            <div>
              ...
              <dd className="text-slate-800 font-medium mt-0.5 break-words">{promoterPlan.displayName}</dd>
            </div>
          </dl>
        </DashboardCard>
        ...
        <DashboardCard title="Preferenze di pagamento">
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-100 text-sm text-slate-500 font-light break-words">
        ...
        <DashboardCard title="Notifiche">
          <p className="break-words">
            Preferenze email per liquidazioni, nuove acquisizioni e aggiornamenti materiali.
          </p>
