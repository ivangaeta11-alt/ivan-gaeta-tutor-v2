  ...
  return (
    <section className="relative pt-24 pb-4 lg:pt-28 lg:pb-5 overflow-hidden bg-white">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="mb-4 sm:mb-5 inline-flex items-center px-5 py-2 rounded-full bg-blue-50/90 border border-blue-100 text-blue-700 shadow-sm gap-2 ring-1 ring-blue-50">
          <GraduationCap className="w-4 h-4 text-blue-600" aria-hidden />
          <span className="text-sm font-semibold">Tutor STEM</span>
        </div>

        <h1 className="max-w-4xl mx-auto text-[2.125rem] sm:text-5xl lg:text-[3.75rem] font-extrabold text-slate-900 leading-[1.08] mb-5 sm:mb-6 tracking-tight">
          Percorsi strutturati in <br className="hidden sm:block" />
          <span className="gradient-text">Matematica e Fisica</span>
        </h1>

        <p className="text-lg sm:text-xl lg:text-2xl text-slate-500 font-light max-w-3xl mx-auto mb-7 sm:mb-8 leading-relaxed">
        ...
        <div
          className="mt-8 sm:mt-10 pt-6 sm:pt-7 border-t border-slate-100 max-w-3xl mx-auto"
